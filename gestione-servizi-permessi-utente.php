...
<body>
    <div class="container my-5">
       ...
       <a id="nuovo" href="crea-servizi-permessi-utente.php" role="button">New Service</a>
       ...
       <table class="table">
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>
                    <a class='modifica' href='modifica-servizi-permessi-utente.php?id=$row[id]'>Edit</a>
                    <a class='elimina' href='elimina-servizi-permessi-utente.php?id=$row[id]'>Delete</a>
                </td>
            </tr>
            ";
        }
