...
<body>
    ...
    <div class="container my-5">
       <h2>List of jobs</h2>
       <a id="nuovo" href="crea-lavori.php" role="button">New Job</a>
       ...
       <table class="table">
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>$row[jobImage]</td>
                <td>
                    <a class='modifica' href='modifica-lavori.php?id=$row[id]'>Edit</a>
                    <a class='elimina' href='elimina-lavori.php?id=$row[id]'>Delete</a>
                </td>
            </tr>
            ";
        }
